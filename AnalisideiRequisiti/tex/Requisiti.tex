...
\begin{document}
	...
	\begin{longtable}{| p{2cm} | p{2.5cm} |p{5cm} | p{2.5cm} |}
		...
		\newline ROF5.3&\newline Obbligatorio&
		\newline Il sistema visualizza un errore se è fallita l'apertura del file system&
		\newline \refer{UC3.3} \newline  VE-15-12-2017
		\\[1em]	
		\hline
