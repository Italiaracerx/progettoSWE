...
Il presente documento si pone l’obbiettivo di trattare in modo esaustivo l’esposizione dei \glossario{\textit{casi d’uso}}{casi d'uso} e di tutti quei \glossario{\textit{requisiti}}{requisiti} che si sono palesati in seguito ad un’attenta analisi del \glossario{\textit{capitolato}}{capitolato} d’appalto \textit{DeSpeect: interfaccia grafica per Speect} (C3) e a riunioni interne ed esterne verbalizzate.
