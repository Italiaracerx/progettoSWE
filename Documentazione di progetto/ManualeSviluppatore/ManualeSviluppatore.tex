...
\begin{itemize}
	...
	\item \textbf{Utterance}: incapsula i dati relativi all'utterance e ne gestisce la memoria;
	\item \textbf{Relation}: incapsula i dati relativi alla relation e ne gestisce la memoria;
