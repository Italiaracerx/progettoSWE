...
\newglossaryentry{Relation}{name={Relation}, description={Rappresentano strutture come parole, sillabe, fonemi o anche obiettivi di durata e gli item sono il contenuto di queste strutture.}}
...
\begin{document}
	...
	\section{IDE}
	Il progetto DeSpeect non è necessariamente legato ad alcun \gls{IDE}, tuttavia si consiglia l'uso di \glossario{Qt}{Qt} e \textit{Qt Creator}. Le librerie Qt sono infatti utilizzate all'interno del prodotto per la realizzazione dell'interfaccia grafica, e l'adozione dei succitati IDE ne agevola notevolmente l'impiego nell'ottica di modifiche e/o estensioni alla stessa. Viene di seguito illustrata la procedura per l'installazione dell'IDE e l'importazione del progetto.
