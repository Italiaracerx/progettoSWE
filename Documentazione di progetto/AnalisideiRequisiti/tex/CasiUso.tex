...
\begin{document}
	...
	{\begin{itemize}
			\item{} L'attore può aprire il menu File \refer{UC2};
	...
	{	\begin{itemize}
		\item{} L'attore può caricare un file \verb|.json| \refer{UC3};
		\item{} L'attore può salvare le modifiche al file \verb|.json| \refer{UC11};
	...
	{L'attore ha selezionato la voce relativa nel menu \refer{UC2}}
	...
	{Speect fallisce l'inizializzazione e l'attore visualizza il messaggio d'errore relativo al file \refer{UC3.1}}
...
{\'E presente almeno un'utterance type e questa è selezionata \refer{UC12}}
...
{Un'utterance type è stata selezionata \refer{UC12} }
...
{Esiste un file \verb|.json| correttamente caricato \refer{UC3} e l'attore ha modificato gli utterance processor \refer{UC6.2} \refer{UC6.3}}
...
{Un'utterance type è stata scelta \refer{UC12}}
