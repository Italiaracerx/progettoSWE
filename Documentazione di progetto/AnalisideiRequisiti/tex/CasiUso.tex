...
\begin{document}
	...
	{\begin{itemize}
			...
			\item{} L'attore può caricare un file JSon \refer{UC3};
	...
	{Speect fallisce l'inizializzazione e l'attore visualizza il messaggio dell'errore relativo al file \refer{UC3.1}}
...
{Un file JSon è stato caricato correttamente \refer{UC3}}
...
{Il file JSon è stato caricato correttamente \refer{UC3}}
...
{Esiste un file Json correttamente caricato \refer{UC3} e l'attore ha modificato gli Utterance Processor \refer{UC6.2} \refer{UC6.3}}
