...
\begin{document}
	...
	La pianificazione del lavoro è stata costruita sulla base delle scadenze elencate in §1.5 del presente documento. In base ad esse, si è suddiviso lo sviluppo nei periodi seguenti:
	\begin{itemize}
		\item Analisi;
