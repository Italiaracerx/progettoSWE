...
\subsection{Progettazione} 
	...
	La Progettazione si colloca nel periodo "Progettazione e codifica" dettagliato nel PP (§4.4), vengono individuati i design pattern e costruita l'architettura del prodotto realizzando diagrammi di classi e di sequenza: il lavoro svolto rappresenta la \textit{Product Baseline}. \\
