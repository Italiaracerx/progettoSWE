...
\begin{longtable}[c]{| p{2.5cm} |p{8cm} | p{2.5cm} |}
	...
	\hline
	\newline TU6&
	\newline Viene verificato il corretto caricamento degli \verb|utterance processor|&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU7&
	...
	\hline
	\newline TU8&
	\newline Viene verificata la corretta emissione di un errore in caso di tentativo di processo senza \verb|utterance type|&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU9&
	...
	\hline
	\newline TU39&
	\newline Viene verificata la corretta selezione del nodo tramite path&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU40&
