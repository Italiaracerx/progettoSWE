...
\begin{itemize}
	...
	\item \textbf{MPPS010 - Rapporto tra linee di codice e linee di commento}: la media dei rapporti tra linee di codice e linee di commento è \textit{12.1\%}, valore fuori dal range di accettabilità definito, che il gruppo intende abbassare drasticamente nel corso dell'ultimo periodo di progetto.
\end{itemize}
