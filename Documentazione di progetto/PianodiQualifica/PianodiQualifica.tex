...
\begin{itemize}
	\item \textbf{MPPS001 - Copertura requisiti obbligatori}: ;
	\item \textbf{MPPS002 - Copertura del codice}: ;
	\item \textbf{MPPS003 - Percentuale superamento test}: ;
	\item \textbf{MPPS004 - Numero di parametri per metodo}: ;
	\item \textbf{MPPS005 - Numero di attributi per classe}: ;
	\item \textbf{MPPS006 - Numero di metodi per classe}: ;
	\item \textbf{MPPS007 - Complessità ciclomatica}: ;
	\item \textbf{MPPS008 - Grado di instabilità}: ;
	\item \textbf{MPPS009 - Altezza albero della gerarchia}: ;
	\item \textbf{MPPS010 - Rapporto tra linee di codice e linee di commento}: .
\end{itemize}
