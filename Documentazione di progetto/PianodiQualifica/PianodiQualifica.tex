...
\begin{longtable}{|p{20mm}|p{20mm}|p{40mm}|p{30mm}|p{50mm}|}
	...
	\textbf{Versione} & \textbf{Data} & \textbf{Autore} & \textbf{Ruolo} & \textbf{Descrizione} \\
		...
		\hline 4.0.0 & 2018-05-10 & Giulio Rossetti & Amministratore & Approvazione \\ 
...
\begin{itemize}
	...
	\begin{figure}[H]
		...
		\centering
		\caption{Andamento della copertura dei requisiti, periodo di verifica e validazione}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\centering
		\caption{Andamento della copertura del codice, periodo di verifica e validazione}
	\end{figure}
...
\subsubsection*{Tabella riepilogativa delle rilevazioni metriche}
\begin{longtable}{| p{2cm} | p{3.5cm} |p{5.5cm} | p{3cm} |}
	\caption {Tabella rilevazioni metriche per i processi} \label{tab:metriche} \\
	\hline
	...
	\newline \textbf{Accettazione:} [65\% - 100\%]
	\newline \textbf{Ottimale:} [85\% - 100\%] &
	\newline 97.3\% (line coverage) - 66.5\% (condition coverage)
	\\[1em]
