...
\begin{itemize}
	...
	\item \textbf{MPPS010 - Rapporto tra linee di codice e linee di commento}: la media dei rapporti tra linee di commento e linee di codice è \textit{12.1\%}, valore fuori dal range di accettabilità definito, il gruppo intende aumentare drasticamente la percentuale nel corso dell'ultimo periodo di progetto.
\end{itemize}
