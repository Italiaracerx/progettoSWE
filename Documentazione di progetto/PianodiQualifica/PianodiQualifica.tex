...
\begin{longtable}{|p{20mm}|p{20mm}|p{40mm}|p{30mm}|p{50mm}|}
	...
	\textbf{Versione} & \textbf{Data} & \textbf{Autore} & \textbf{Ruolo} & \textbf{Descrizione} \\
		...
		\hline 3.1.0 & 2018-04-28 & Cristiano Tessarolo & Verificatore & Verifica appendice §B e §2.2 \\
		\hline 3.0.2 & 2018-04-26 & Manfredi Smaniotto & Programmatore & Rivisita §2.2 \\
...
\chapter{Introduzione}
    ...
    Al fine di evitare ogni ambiguità relativa al linguaggio utilizzato nei documenti, viene fornito il \textit{Glossario v4.0.0}, contenente la definizione dei termini in corsivo marcati con il pedice "G".
    ...
    \begin{itemize}
        \item \textbf{Piano di Progetto:} documento \textit{Piano di Progetto v4.0.0};
	        \begin{itemize}
...
In questa appendice vengono illustrati nel dettaglio i test da eseguirsi sul prodotto software, secondo classificazione introdotta nelle NP (§3.4.5 "Test"). Si vuole sottolineare l'incrementalità della presente appendice, che andrà ad espandersi in maniera proporzionale allo sviluppo del software.
...
\setlength\LTleft{6mm}
	...
	\hline
	\newline TSOF1&
	\newline L'utente può accedere al menù file&
	\newline \textcolor{green}{Superato}
	\\[1em]	
	...
	\newline TSDF6.1.1&
	\newline L'utente può spostare gli utterance processor di un ttterance type&
	\newline Non implementato
	\\[1em]
	\hline	
	...
	\hline
	\newline TSOF8&
	\newline L'utente può eseguire Speect per il testo inserito&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TSOF8.1&
	\newline Il sistema visualizza un errore di esecuzione se Speect fallisce l'esecuzione&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	...
	\newline TSDF9.3.1.1&
	\newline L'utente può modificare il \textit{name} del nodo selezionato&
	\newline Non implementato
	\\[1em]
	\hline
...
\begin{longtable}[c]{| p{2.5cm} |p{8cm} | p{2.5cm} |}
	...
	\begin{itemize}
		...
		\item premere su Save Json File.
	\end{itemize}&
	\newline Non implementato
	\\[1em]	
	\hline
	...
	\newline TVOF4&
	\newline L'utente può salvare l'audio risultante con estensione \verb|.wav|. L'utente deve:
	\begin{itemize}
		\item selezionare Save Audio File da menù File;
		\item aprire il file browser;
		\item spostarsi nella cartella di destinazione;
	...
	\hline
	\newline TVOF6&
	\newline L'utente può selezionare l'utterance type. L'utente deve:
	\begin{itemize}
		\item aprire il menù a tendina relativo;
	...
	\hline
	\newline TVOF8.1&
	\newline Il sistema visualizza un errore di esecuzione se Speect fallisce l'esecuzione. L'utente deve:
	\begin{itemize}
	...
	\newline TVDF9.3.1.1&
	\newline L'utente può modificare il \textit{name} del nodo selezionato. L'utente deve:
	\begin{itemize}
		\item selezionare il nodo desiderato;
		\item selezionare la casella di testo del \textit{name};
		\item modificare il \textit{name};
	...
	\begin{itemize}
		\item selezionare il nodo desiderato;
		\item premere su menù File;
		\item premere su Search Path;
		\item inserire il percorso da cercare;
		\item premere su Search.
	\end{itemize}&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	...
	\newline TVDF9.5.1&
	\newline L'utente può modificare il colore con cui si evidenzia il focus. L'utente deve:
	\begin{itemize}
		\item selezionare il nodo desiderato;
	...
	\begin{itemize}
		\item selezionare Import Graph da menù File;
		\item aprire il file browser;
		\item selezionare il file da importare;
		\item confermare l'importazione.
	\end{itemize}&
	\newline Non implementato
	\\[1em]
	\hline
...
\begin{longtable}[c]{| p{2.5cm} |p{8cm} | p{2.5cm} |}
	...
	\hline
	\newline TU4&
	\newline Viene verificato il corretto caricamento dell'\verb|utterance type|&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU5&
	\newline Viene verificato che il testo venga caricato in \textit{Speect} correttamente&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU6&
	...
	\hline
	\newline TU7&
	\newline Viene verificato che l'esecuzione degli utterance processor selezionati avvenga correttamente&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU8&
	...
	\hline
	\newline TU11&
	\newline Viene verificato il caricamento di un plug-in&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU12&
	\newline Viene verificata la corretta emissione di un errore in caso di mancato caricamento di un plug-in su \textit{Speect}&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU13&
	\newline Viene verificata la corretta configurazione di Speect&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU14&
	\newline Viene verificata la corretta configurazione di Speect dopo la modifica&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU15&
	...
	\hline
	\newline TU20&
	\newline Viene verificata la corretta visualizzazione di ogni arco&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU21&
	...
	\hline
	\newline TU31&
	\newline Viene verificata la corretta richiesta di esecuzione di un processor&
	\newline \textcolor{green}{Superato}
	\\[1em]
	\hline
	\newline TU32&
...
\begin{figure}[H]
	\includegraphics[scale=0.5]{/Spice/spice-verifica}
	\centering
...
\begin{itemize}
	...
	\begin{table}[h]
		\begin{center}
			...
			\begin{longtable}{|p{60mm}|p{30mm}|p{25mm}|}
				\hline  
				\textbf{Nome Documento} & \textbf{Valore Indice} & \textbf{Esito} \\ \hline    
				\textit{Glossario v 4.0.0} & 56 & Positivo\\ \hline    
	...
	\begin{figure}[H]
		\includegraphics[scale=0.5]{/Gulpease/gulpease-verifica}
		\centering
...
\begin{itemize}
	...
	\begin{figure}[H]
		\includegraphics[scale=0.4]{/CoperturaRequisiti/copertura-requisiti-verifica}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[scale=0.4]{/CoperturaCodice/copertura-codice-verifica}
		\centering
