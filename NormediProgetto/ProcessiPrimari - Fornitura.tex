...
stato compito del \glossario{Responsabile di Progetto} convocare una riunione interna al gruppo per valutare le proposte di progetto pervenute. Gli \glossario{Analisti} hanno condotto un'approfondita attività di analisi dei rischi e delle opportunità su ciascun capitolato, che ha portato alla stesura del documento Studio di Fattibilità v1.0.0.
...
\begin{itemize}
    ...
    \item{Dominio applicativo:} analisi \glossario{Dominio Applicativo}, cioè l'ambito di utilizzo del prodotto da sviluppare;
...
\subsubsection{Scopo}
Lo scopo del documento è l'esposizione dettagliata della pianificazione cui attenersi nel corso della realizzazione del progetto, redatta dal \glossario{Responsabile di Progetto} coadiuvato dagli \glossario{Amministratori}. 
...
\subsubsection{Scopo}
Lo scopo del documento è l'esposizione della strategia individuata dai \glossario{Verificatori} per la \glossario{Verifica} e la \glossario{Validazione} del materiale prodotto dal gruppo. 
