...
\begin{itemize}
    ...
    \item{Dominio applicativo:} analisi \glossario{Dominio Applicativo}{dominio applicativo}, cioè l'ambito di utilizzo del prodotto da sviluppare;
