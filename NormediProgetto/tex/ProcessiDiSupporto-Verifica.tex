...
Il gruppo utilizza entrambe le tecniche di analisi statica e fa inoltre uso di uno strumento automatico per il calcolo dell'\glossario{indice Gulpease}{indice Gulpease}, la cui descrizione è illustrata nel capitolo \textit{Strumentazione} di questo documento.
...
razioni apposite delle metriche illustrate in §3 \Metriche e Misure" del PQ.
