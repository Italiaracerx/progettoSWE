...
e conoscenza delle Norme di Progetto e del \glossario{Piano di Qualifica}. Utilizzando questa
...
Il test di regressione deve essere eseguito ad ogni modifica di un’\glossario{implementazione} del
...
Il test di accettazione prevede il \glossario{collaudo} del prodotto in presenza del \glossario{proponente} e,
