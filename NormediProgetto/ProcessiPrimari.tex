...
\section{Analisi dei Requisiti}
	...
	\subsection{Scopo} Gli \glossario{analisti} devono individuare ed elencare i \glossario{requisiti} del progetto da realizzare.
	...
	\begin{enumerate}
		...
		\item Fornire ai \glossario{Verificatori} indicazioni per le attività di test.
	...
	\subsection{Classificazione requisiti:} I requisiti devono essere suddivisi per importanza e classificati come segue: R[Importanza][Tipologia][Codice]. Inoltre, di ogni requisito si vuole tener traccia della fonte e deve essere definita una descrizione.
		\begin{enumerate}
			...
			\begin{itemize}
				\item V: Identifica un \glossario{requisito di vincolo};
				\item F: Identifica un \glossario{requisito funzionale};
				\item P: Identifica un \glossario{requisito prestazionale};
				\item Q: 
				Identifica un \glossario{requisito di qualità}.
			\end{itemize}
	...
	I \glossario{casi d'uso} verranno identificati nel seguente modo: UC[P][I].
	\begin{itemize}
