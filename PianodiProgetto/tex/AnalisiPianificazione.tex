...
\begin{figure}	
	\centering	
	\includegraphics{AnalisiGantt.png}	
	\caption{Diagramma di Gantt di Analisi}\label{Figura 1:}	
\end{figure}
...
\begin{figure}	
	\centering	
	\includegraphics{ConsolidamentoGantt.png}	
	\caption{Diagramma di Gantt di Consolidamento dei requisiti}\label{Figura 2:}	
\end{figure}
...
\begin{figure}	
	...
	\caption{Diagramma di Gantt di Progettazione architetturale}\label{Figura 3:}	
\end{figure}
...
\begin{figure}	
	\centering	
	\includegraphics{ProgCodifica.png}	
	\caption{Diagramma di Gantt di Progettazione di dettaglio e Codifica}\label{Figura 4:}	
\end{figure}
...
\begin{figure}	
	\centering	
	\includegraphics{ValidazioneCollaudo.png}	
	\caption{Diagramma di Gantt di Validazine e collaudo}\label{Figura 5:}	
\end{figure}
\end{document}