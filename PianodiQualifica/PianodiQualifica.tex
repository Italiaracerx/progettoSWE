...
\begin{table}
	\begin{center}
		\begin{tabular}{|c|c|}
			\hline
			\hline \textbf{Processo} & \textbf{Livello SPICE} \\
			\hline Fornitura & 3 \\
			\hline Sviluppo & 2 \\
			\hline Documentazione & 3 \\
			\hline Verifica & 2 \\
			\hline Gestione & 3 \\
			\hline
	\end{tabular}
\end{center}
\caption{Livello SPICE periodo di Analisi} 
\end{table}
...
Segue riassunto del calcolo dell'Indice Gulpease [MPPD002] (al netto di tabelle e frontespizio) e il quello del numero di Errori ortografici corretti [MPPD001].
