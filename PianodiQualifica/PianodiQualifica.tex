...
In questa appendice vengono illustrati nel dettaglio i test da eseguirsi sul prodotto software, secondo classificazione introdotta nelle NP (§3.4.6.2 "Test"). Si vuole sottolineare l'incrementalità della presente appendice, che andrà ad espandersi in maniera proporzionale al software.
...
Verranno qui presentati i test eseguiti ad ogni modifica di un'implementazione all'interno del sistema.

\section{Test di Sistema}

Verranno qui presentati i test previsti per assicurare che il sistema rispetti le specifiche esplicitate dai requisiti (elencati nell'AR) e per garantire il buon funzionamento del prodotto.

\section{Test di Validazione}

Verranno qui presentati i test per l'accettazione del software, con i quali si accerta che il prodotto sia conforme alle attese del Committente.
